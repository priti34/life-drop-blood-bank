    ...
    <div class="tab-content">
       ...
       <div class="tab-pane container active" id="hospitals">
        ...
        <form action="file/hospitalReg.php" method="post" enctype="multipart/form-data">
          ...
          <input type="tel" name="hphone" placeholder="Hospital Phone Number" class="form-control mb-3" required pattern="[6-9]{1}[0-9]{9,11}" title="Phone number  must have start from ,6,7,8 or 9 and must have 10 to 12 digit">
       ...
       <div class="tab-pane container fade" id="receivers">
        ...
        <form action="file/receiverReg.php" method="post" enctype="multipart/form-data">
          ...
          <input type="tel" name="rphone" placeholder="User Phone Number" class="form-control mb-3" required pattern="[6-9]{1}[0-9]{9,11}" title="Phone number must have start from 6,7,8 or 9 and must have 10 to 12 digit">
