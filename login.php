    ...
    <div class="tab-content">
       <div class="tab-pane container active" id="hospitals">
        <form action="file/hospitalLogin.php" class="login-form" method="post">
          <label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Hospital Email/Phone Number</label>
          <input type="email" name="hemail" placeholder="Hospital Email/Phone Number" class="form-control mb-4">
      ...
      <div class="tab-pane container fade" id="receivers">
         <form action="file/receiverLogin.php" class="login-form" method="post">
          <label class="text-muted font-weight-bold" class="text-muted font-weight-bold">User Email/Phone Number</label>
          <input type="email" name="remail" placeholder="User Email/Phone Number" class="form-control mb-4">
