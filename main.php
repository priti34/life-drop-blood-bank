...
<!DOCTYPE html>
<html>
<?php $title=" Life Drop Blood Bank Management System | home page"; ?>
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="image/slide1.2.jpg" alt="New York" width="1100" height="500">
    </div>
  </div>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-12">
        <img src="image/cfdfgc.jpg" class="img-fluid aboutimg">
      </div>
      <div class="col-lg-6 col-md-6 col-12">
      <h2>BLOOD - "I'm here to save you!"</h2>
      <h5 class="py-3">We believe Every life counts!, Every life matters. <br>Time is the thing we have and don't.<br> Our goal is to make blood available in less time and save your precious life!</h5>
      <a href="about.php"> </a> 
      </div>
    </div>
  </div>
...
<section class="my-5">
  ...
  <p class="text-center bg-dark text-white">lifedropbloodbank@gmail.com<br>+91-67890-65634<br>lifedrop.official</p>
